...
(async () => {
  ...
  `;
    ...
    const worksCardsData = [
      {
        img: (await import('./assets/img/works/hand_watch.webp')).default,
        title: 'Hand Watch',
        tag: 'ui/ux design',
      },
      {
        img: (await import('./assets/img/works/one_day_pass.webp')).default,
        title: 'One Day Pass',
        tag: 'ui/ux design',
      },
      {
        img: (await import('./assets/img/works/t_shirts.webp')).default,
        title: 'T-Shirts',
        tag: 'ui/ux design',
      },
      {
        img: (await import('./assets/img/works/packet_bottle.webp')).default,
        title: 'Packet Bottle',
        tag: 'ui/ux design',
      },
      {
        img: (await import('./assets/img/works/bottle.webp')).default,
        title: 'Bottle',
        tag: 'ui/ux design',
      },
      {
        img: (await import('./assets/img/works/bag.webp')).default,
        title: 'Bag',
        tag: 'ui/ux design',
      },
    ];
  ...
  `;
    ...
    const blogPostsData = [
      {
        img: (await import('./assets/img/posts/post1.webp')).default,
      ...
      {
        img: (await import('./assets/img/posts/post2.webp')).default,
      ...
      {
        img: (await import('./assets/img/posts/post3.webp')).default,
